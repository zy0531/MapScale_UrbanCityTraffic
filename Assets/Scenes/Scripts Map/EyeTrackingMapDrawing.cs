...
public class EyeTrackingMapDrawing : MonoBehaviour
{
    [Header("Gaze data")]
    ...
    private static readonly string[] ColumnNames = { "Trial", "Time",
        ...
        "HoldingObjectName", "HoldingObjectPosition"
        };
    ...
    void LogGazeData(VarjoEyeTracking.GazeData data, VarjoEyeTracking.EyeMeasurements eyeMeasurements)
    {
        ...
        // Holding Object by the Controller
        logData[32] = dragdrop.GetHoldingObjectName();
        logData[33] = dragdrop.GetHoldingObjectPosition().ToString("F3");
