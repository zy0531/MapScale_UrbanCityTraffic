// ****************************************************************************
//<copyright file=Geosim_Uber_Opaque company="GeoSim Systems Ltd">
// Copyright © 2000-2018 GeoSim Systems Ltd. All rights reserved. 
//</copyright>
// ****************************************************************************
Shader "Geosim/x/Uber/Geosim_Uber_Opaque"
{
	Properties
	{
		...
		cPack1("cReflAmount,cReflrPerturb,cDetailFunc,cParallaxAmount", Vector) = (0,0,2,0)
	}
	...
	SubShader
	{
		...
		CGPROGRAM
			#pragma target 3.0     
			#pragma surface SurfaceOpaque PhongGeosim vertex:VertOpaque  dithercrossfade
			...
			void SurfaceOpaque(Input IN, inout GSSurfaceOutput o)
			{
				...
				#if PARALLAX           
					half fHeight = tex2D(cBumpMap ,IN.oTexcoord0).r;
					IN.oTexcoord0.xy += ParallaxOffsetFunc(fHeight, cPack1.w, IN.viewDir);
					o.Normal = normalize(UnpackCompNormal(tex2D(cBumpMap, IN.oTexcoord0.xy).ag));
				#endif     
